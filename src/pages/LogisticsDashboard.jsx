...
export const LogisticsDashboard = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      {/* Top Banner */}
      <div className="bg-gradient-to-r from-slate-900 via-teal-950 to-slate-900 text-white rounded-3xl p-6 shadow-xl border border-slate-800 flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="space-y-1">
          ...
          <h1 className="text-2xl sm:text-3xl font-black">Driver & Dispatch Dashboard</h1>
        ...
        <div className="bg-slate-800 p-4 rounded-2xl border border-slate-700 text-center shrink-0">
          <p className="text-[10px] text-emerald-400 font-mono uppercase font-bold">Vehicle Capacity</p>
          <p className="text-2xl font-black text-white">850 kg / 1000 kg</p>
          <p className="text-[10px] text-slate-400">Tata Ace EV (MP-04-KC-2024)</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200 shadow-sm space-y-6">
        <div className="flex items-center justify-between border-b border-slate-100 pb-4">
          <h2 className="text-xl font-black text-slate-900">Active Cargo Pickups & Routes</h2>
          <button
          ...
          {orders.map((ord, idx) => (
            <div key={idx} className="bg-slate-50 rounded-2xl p-5 border border-slate-200 space-y-4">
              ...
              <div className="space-y-2 text-xs">
                <p className="font-extrabold text-slate-900 text-sm">{ord.productName} ({ord.quantity} {ord.unit || 'kg'})</p>
